...
export const BUILD_INFO_FALLBACK = {
  ...
  admin_panel_version: process.env.REACT_APP_ADMIN_PANEL_VERSION || '1.5.3-admin',
  frontend_version: process.env.REACT_APP_FRONTEND_VERSION || '2.3.3-beta-deploy',
  build_number: process.env.REACT_APP_BUILD_NUMBER || '2026.04.23.6',
  build_date: process.env.REACT_APP_BUILD_DATE || '2026-04-23T13:13:04+07:00',
  build_date_human: process.env.REACT_APP_BUILD_DATE_HUMAN || '23.04.2026, 13:13:04',
